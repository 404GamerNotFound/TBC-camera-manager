...
def _detection(key: str, cx: float = 0.5, cy: float = 0.5) -> Detection:
    return Detection(label=key, detection_key=key, confidence=0.9, box=(cx - 0.02, cy - 0.02, cx + 0.02, cy + 0.02))

...
![Adding a camera](images/readme/add-camera.png)
...
![Camera plugins](images/readme/camera_plugins.png)
...
![AI detection](images/readme/ai_detection.png)
...
- Live view: authenticated HLS playlists and segments generated by `ffmpeg`, plus an optional bundled `go2rtc` process for WebRTC (WHEP signaling proxied through an authenticated route; media flows directly between browser and go2rtc on port `8555`)
